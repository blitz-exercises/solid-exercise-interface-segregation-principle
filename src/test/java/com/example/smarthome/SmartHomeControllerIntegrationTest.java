 ...
 * The SmartHomeService interface defines the public API contract that must be maintained.
 */
public class SmartHomeControllerIntegrationTest {
    ...
    void testInvalidDeviceOperations() {
        ...
        assertThrows(IllegalArgumentException.class, 
                () -> controller.turnOnLight("thermo-001"),
        ...
        assertThrows(IllegalArgumentException.class,
                () -> controller.startRecording("thermo-001"),
    ...
    void testNonExistentDevice() {
        assertThrows(IllegalArgumentException.class,
                () -> controller.turnOnLight("non-existent"),
